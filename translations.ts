...
export const translations: Record<Language, any> = {
  et: {
    ...
    wizardLoadingDesc: 'Valin parimat varustust sinu jõusaalist ja optimeerin harjutuste järjekorda...',
    finish: 'Lõpeta',
    next: 'Edasi',
    back: 'Tagasi',
    day: 'Päev',
    ...
    goalHypertrophy: 'Hüpertroofia (Lihaskasv)',
    goalMaxStrength: 'Maksimumjõud',
    goalCardio: 'Vastupidavus / Kardio',
    goalRehab: 'Taastusravi',
    goalPower: 'Plahvatuslik jõud',
    remove: 'Eemalda',
  ...
  en: {
    ...
    wizardLoadingDesc: 'Selecting the best equipment from your gym and optimizing exercise order...',
    finish: 'Finish',
    next: 'Next',
    back: 'Back',
    day: 'Day',
    ...
    goalHypertrophy: 'Hypertrophy (Muscle Growth)',
    goalMaxStrength: 'Max Strength',
    goalCardio: 'Endurance / Cardio',
    goalRehab: 'Rehabilitation',
    goalPower: 'Explosive Power',
    remove: 'Remove',
  ...
  ru: {
    ...
    wizardLoadingDesc: 'Подбираю лучшее оборудование в вашем зале и оптимизирую порядок упражнений...',
    finish: 'Завершить',
    next: 'Далее',
    back: 'Назад',
    day: 'День',
    ...
    goalHypertrophy: 'Гипертрофия (Рост мышц)',
    goalMaxStrength: 'Максимальная сила',
    goalCardio: 'Выносливость / Кардио',
    goalRehab: 'Реабилитация',
    goalPower: 'Взрывная сила',
    remove: 'Удалить',
