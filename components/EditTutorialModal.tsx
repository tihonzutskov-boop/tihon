              ...
              <div className="rounded-xl overflow-hidden border border-slate-800">
                ...
                <div className="relative aspect-video bg-black">
                  ...
                  <div className={`absolute inset-x-0 bottom-0 p-3 transition-opacity duration-200 ${captionFading ? 'opacity-0' : 'opacity-100'}`}>
                    <div className="flex items-center justify-between mb-1.5">
                      <span className="text-[9px] font-extrabold uppercase tracking-wide text-white/60" style={{ textShadow: '0 1px 4px rgba(0,0,0,0.8)' }}>Step {clampPreviewIdx + 1} of {steps.length}</span>
